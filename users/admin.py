...
admin.site.site_header = "HUMASCOT-JOB admin page"
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ["id", "name", "email", "is_active", "is_client", "is_admin"]
    list_display_links = ["name", "email"]
    list_filter = ["is_admin", "is_active", "is_client"]
    fieldsets = [
        (
            None,
            {
        ...
        ("authority", {"fields": ["is_admin", "is_client"]}),
    ]
    add_fieldsets = [
        (
            None,
    ...
    # name and subscription date are set so that they cannot be modified on the admin page.
